...
const ConfigPanel: React.FC<ConfigPanelProps> = ({ config, onConfigChange, onOpenLocalDb }) => {
  ...
  return (
    <div className="bg-white shadow-sm border-r border-gray-200 w-80 p-6 overflow-y-auto">
      <div className="space-y-6">
        {/* 标题 */}
        <div>
          <h1 className="text-2xl font-bold text-gray-900">昆山市尚为人力资源配置服务有限公司投标助手</h1>
        ...
        <div className="border-t border-gray-200 pt-4">
          <button
            ...
            className="w-full inline-flex justify-center items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 disabled:bg-gray-400"
          >
            🗄️ 公司本地数据库
          </button>
        </div>
